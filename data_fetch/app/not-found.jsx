  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#111321] text-white p-4">
      ...
      <div className="flex gap-4">
        <Link href="/jokes">
          <button className="flex items-center gap-2 px-6 py-2.5 bg-[#1e2135] hover:bg-[#2a2e45] border border-gray-700 rounded-lg font-medium transition-all">
            <span>←</span> Go To Jokes
          </button>
        </Link>
      </div>
    </div>
